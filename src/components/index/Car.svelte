  ...
  <g id="MinibusLayer2" data-name="Layer 2">
    <g id="MinibusForeground">
      <g id="minibus">
        ...
        <circle class="{lightMode ? `minib-cls-7` : `minib-class-6`}" cx="274.05" cy="506.82" r="63.04" />
        <circle class="{lightMode ? `minib-cls-7` : `minib-class-6`}" cx="1152.18" cy="506.82" r="63.04" />
      </g>
    </g>
  </g>
</svg>
